...
try {
    ...
    $pdo->exec("TRUNCATE TABLE cad_escola");
    ...
    for ($i = 1; $i < count($dados); $i++) {
        ...
        $nome = limpar($linha[$campos["NOME DA INSTITUIÇÃO DE ENSINO:"]]);
        ...
        $numero = limpar($linha[$campos['NÚMERO ("S/N" caso não houver):']]);
        ...
        $sql = "INSERT INTO cad_escola (
            nome_escola, numero_cnpj, numero_telefone,
